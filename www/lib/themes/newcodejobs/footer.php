        ...
        <footer>
            <p>
                <?php 
                    ...
                    ?>
                        <a href="<?php print path(slug(__("Advertising")), FALSE, FALSE); ?>"><?php print __("Advertising"); ?></a> &nbsp;&nbsp;
                		...
                		<a href="<?php print path("feedback"); ?>"><?php print __("Contact us"); ?></a><br />
                    <?php
                    }
                    
                    print __(_("This site is licensed under a")); ?> 
