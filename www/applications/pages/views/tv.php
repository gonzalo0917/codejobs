...
<html lang="es">
	...
	<body>
		...
		<div class="sponsors" style="text-align: center; margin-top: 0px;">
			...
			<a rel="nofollow" target="_blank" href="http://www.infranetworking.com"><img src="<?php echo path("www/applications/pages/views/images/patrocinadores/infranetworking_small.png", true); ?>" alt="" /></a>
