...
class ZP_Files extends ZP_Load {
	...
	public function getFileInformation($filename = FALSE) {
		...
		if(is_array($parts)) {
			...
			$icons = array(
				"txt"  => array(get("webURL") ."www/lib/images/icons/files/text.png", __("Text File")),
				"doc"  => array(get("webURL") ."/www/lib/images/icons/files/doc.png", __("Document File")),
				"docx" => array(get("webURL") ."/www/lib/images/icons/files/doc.png", __("Document File")),
			 	"pdf"  => array(get("webURL") ."/www/lib/images/icons/files/pdf.png", __("PDF File")),
			 	"ppt"  => array(get("webURL") ."/www/lib/images/icons/files/ppt.png", __("Power Point File")),
			 	"pptx" => array(get("webURL") ."/www/lib/images/icons/files/ppt.png", __("Power Point File")),
			 	"rar"  => array(get("webURL") ."/www/lib/images/icons/files/rar.png", __("WinRAR File")),
			 	"iso"  => array(get("webURL") ."/www/lib/images/icons/files/rar.png", __("ISO File")),
			 	"xls"  => array(get("webURL") ."/www/lib/images/icons/files/xls.png", __("Excel File")),
			 	"xlsx" => array(get("webURL") ."/www/lib/images/icons/files/xls.png", __("Excel File")),
			 	"csv"  => array(get("webURL") ."/www/lib/images/icons/files/xls.png", __("Excel File")),
			 	"zip"  => array(get("webURL") ."/www/lib/images/icons/files/zip.png", __("WinZIP File")),
			 	"7z"   => array(get("webURL") ."/www/lib/images/icons/files/7z.png",  __("7z File")),
			 	"ai"   => array(get("webURL") ."/www/lib/images/icons/files/ai.png",  __("Adobe Illustrator File")),
			 	"svg"  => array(get("webURL") ."/www/lib/images/icons/files/ai.png",  __("Adobe Illustrator File")),
			 	"cdr"  => array(get("webURL") ."/www/lib/images/icons/files/cdr.png", __("Corel Draw File")),
			 	"msi"  => array(get("webURL") ."/www/lib/images/icons/files/exe.png", __("Executable File")),
			 	"exe"  => array(get("webURL") ."/www/lib/images/icons/files/exe.png", __("Executable File")),
			 	"dmg"  => array(get("webURL") ."/www/lib/images/icons/files/exe.png", __("Executable File")),
			 	"pkg"  => array(get("webURL") ."/www/lib/images/icons/files/exe.png", __("Executable File")),
			);
