...
--
-- Servidor: localhost
-- Tiempo de generación: 30-05-2013 a las 03:59:46
...
INSERT INTO `muu_forums` (`ID_Forum`, `Title`, `Slug`, `Description`, `Topics`, `Replies`, `Last_Reply`, `Last_Date`, `Total_Posts`, `Language`, `Situation`) VALUES
(1, 'Programación', 'programacion', 'aasdasdsadasdasdasdasd', 0, 0, 0, '', 0, 'Spanish', 'Active'),
(2, 'PHP', 'php', 'SADSADSADASD', 0, 0, 0, '', 0, 'Spanish', 'Active');
...
--
-- Estructura de tabla para la tabla `muu_newsletters`
--

CREATE TABLE IF NOT EXISTS `muu_newsletters` (
...
(1, 1, '', 'admin', 'b9223847e1566884893656e84798ff39cea2b8c4', 'azapedia@gmail.com', 'http://www.codejobs.biz', 'default.png', '0,0,90,90', 76, 143, '', 0, 1, 0, 0, 0, 0, 42, 17, 0, 0, 0, 0, '', 'Carlos Santana Roldán', 18, '', '', '', '2323423423', '23412313123', 'M', 'Single', '04/01/1980', 'Mexico', 'Colima', 'Colima', '', '', '', '', '', '', 'Active');
...
--
-- Estructura de tabla para la tabla `muu_users_cv_skills`
--
...
CREATE TABLE IF NOT EXISTS `muu_vacancy` (
  `ID_Vacancy` mediumint(8) NOT NULL AUTO_INCREMENT,
  `Job_Name` varchar(250) NOT NULL,
  `ID_Job` mediumint(8) NOT NULL,
...
INSERT INTO `muu_vacancy` (`ID_Vacancy`, `Job_Name`, `ID_Job`, `Job_Author`, `ID_User`, `Vacancy`, `Vacancy_Email`, `Cv`, `Message`) VALUES
(1, 'Mantenimiento de Software', 1, 'Admin', 1, 'Carlos Santana Roldán', 'azapedia@gmail.com', 'www/lib/files/documents/cv/cv-admin.pdf', 'I''m interested in your Job. Please contact me about position'),
(3, 'Prueba2', 4, 'admin', 1, 'Carlos Santana RoldÃ¡n', 'azapedia@gmail.com', 'www/lib/files/documents/cv/cv-admin.pdf', 'I''m interested in your Job. Please contact me about position'),
(4, 'Probando', 2, 'admin', 1, '', '', '', '');
